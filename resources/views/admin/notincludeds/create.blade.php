    ...
    <div class="content">
        ...
        <div class="block block-rounded">
            ...
            <div class="block-content">
                <form action="{{ route('notincludeds.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row push">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-8 col-xl-5">
                            <div class="mb-4">
                                <label class="form-label" for="example-text-input">Tour Not Included Items</label>
                                <input type="text" value="{{ old('notincluded_item_name') }}"
